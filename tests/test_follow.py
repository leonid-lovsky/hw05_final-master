...
class TestFollow:
    ...
    def test_follow_auth(self, user_client, user, post):
        ...
        Post.objects.create(text='Тестовый текст 4564534', author=user_1, image=image)
        Post.objects.create(text='Тестовый текст 354745', author=user_1, image=image)

        Post.objects.create(text='Тестовый текст 245456', author=user_2, image=image)
        Post.objects.create(text='Тестовый текст 9789', author=user_2, image=image)
        Post.objects.create(text='Тестовый текст 4574', author=user_2, image=image)
